...
class AdminController
{
    ...
    public function insert()
    {
        ...
        if (!empty($_POST)) {
            ...
            header('Location: __DIR__ . /admin/list?add=' . $success);
        }



        // La vue correspondant à ce controller
        require_once __DIR__ . '../../../../templates/admin/add.php';
    }
    public function edit()
    {
        ...
        if (!empty($_POST)) {
            ...
            header('Location: /Admin/list?edit=' . $success);
        }
    ...
    public function delete()
    {
        ...
        header('Location: /admin/list?delete=' . $success);

        require_once __DIR__ . '../../../../templates/admin/list.php';
    }
